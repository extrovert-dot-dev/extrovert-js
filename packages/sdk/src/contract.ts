 ...
 *
 * {@link CONTRACT_VERSION} is **`0.1.0-pre.14`** - a deliberately **provisional**, pre-1.0
 ...
 *
 * **`0.1.0-pre.14` - PROVISIONAL, pre-1.0.** Versioned *with the SDK* (this package's
 ...
 */
export const CONTRACT_VERSION = "0.1.0-pre.14" as const;
