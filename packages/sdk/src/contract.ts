 ...
 *
 * {@link CONTRACT_VERSION} is **`0.1.4`** - a deliberately **provisional**, pre-1.0
 ...
 *
 * **`0.1.4` - PROVISIONAL, pre-1.0.** Versioned *with the SDK* (this package's
 ...
 */
export const CONTRACT_VERSION = "0.1.4" as const;
