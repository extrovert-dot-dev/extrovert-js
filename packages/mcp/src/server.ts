...
const INSTRUCTIONS = [
  ...
  "",
  "Support: after an unexpected Extrovert failure or inconsistent result, call get_support_settings for the authorized project.",
  "If automatic feedback is permitted and opted in, submit one minimal automatic report with the known task evidence; otherwise ask before reporting.",
  "An explicit reporting request authorizes feedback. Open a support case only when the human requests help or tracking.",
  "Omit unknown versions, transcripts, message bodies and secrets. Never repeat a send to reproduce an error, or recursively report reporting failures.",
  "",
